...
//Say hello to user and ask for city name
        cityname = JOptionPane.showInputDialog(null,"Hello! What city is the user in? ", "Enter city name",JOptionPane.QUESTION_MESSAGE);

//ask for current temp in celcius 
        celsiusString = JOptionPane.showInputDialog(null,"What is the temperature in " + cityname + " in celsius : ", "temperature",JOptionPane.QUESTION_MESSAGE);
